...
def sa_core(html_doc, temp_dir):
    ...
    html_doc = open("%s/temp.html" %temp_dir, encoding="UTF-8")
    ...
    BET_table = re.compile(
        'SBET|BET|Brunauer\s?[−-]?\W?Emmett\s?[−-]?\W?Teller|Langmuir|Surface\s?area|m2/g|SA\W|m2 g-1', re.I)
    ...
    for table in tables:
        ...
        if data != []:
            ...
            if surf_table == 1 and surf_column != []:
                # print ('<Surface area data in table>\n')
                isMOF = 0
                if head_type == 'top':
                    ...
                    if surf_column[i][2] == 'top':
                        for j in range(len(data) - head_row_num):
                            ...
                            if noprint == 0:
                                ...
                                if MOF_column == 1:
                                    ...
                                    Total_DATA.append(
                                        [MOF_name, surf_column[i][1], data[j + head_row_num][surf_column[i][0]][0],
                                         'm2/g'])
                                # print (MOF_name,"|", surf_column[i][1],"|",data[j+head_row_num][surf_column[i][0]][0],"|",'m2/g')
                                ...
                                # print (MOF_name,"|", surf_column[i][1],"|",data[j+head_row_num][surf_column[i][0]][0],"|",'m2/g')
                                    ...
                                    Total_DATA.append(['*NO_MOF_data*', surf_column[i][1],
                                                       data[j + head_row_num][surf_column[i][0]][0], 'm2/g'])
                                # print ('*NO_MOF_data*',"|", surf_column[i][1],"|",data[j+head_row_num][surf_column[i][0]][0],"|",'m2/g')
                        ...
                        for j in range(len(data[i]) - 1):
                            ...
                            if noprint == 0:
                                ...
                                # print (MOF_name,"|", surf_column[i][1],"|", data[surf_column[i][0]][j+1][0],"|", 'm2/g')
                                ...
                                # print ('*NO_MOF_data*',"|", surf_column[i][1],"|", data[surf_column[i][0]][j+1][0],"|", 'm2/g')
    ...
    for i in range(len(sentences)):
        ...
        for match in unit_index:
            ...
            if value != None:
                ...
                print ("No_value before_unit_m2/g")
            value_list.reverse()
